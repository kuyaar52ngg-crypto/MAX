...
const PRESETS: Preset[] = [
  {
    id: "safe",
    label: "Бережный",
    description: "Медленнее, минимальный риск бана",
    icon: Snail,
    values: {
      delay_min: 5,
      delay_max: 15,
      batch_size: 20,
      long_pause_every_n: 20,
      long_pause_seconds: 120,
      broadcast_delay_min: 10,
      broadcast_jitter_max: 5,
      daily_check_limit: 300,
      hourly_check_limit: 50,
  ...
  },
  {
    id: "fast",
    label: "Быстрый",
    description: "Максимальная скорость, выше риск",
    icon: Rabbit,
    values: {
      delay_min: 2,
      delay_max: 4,
      batch_size: 100,
      long_pause_every_n: 100,
      long_pause_seconds: 30,
      broadcast_delay_min: 3,
      broadcast_jitter_max: 2,

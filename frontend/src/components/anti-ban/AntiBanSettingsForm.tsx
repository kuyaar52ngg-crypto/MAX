...
const PRESETS: Preset[] = [
  {
    id: "safe",
    label: "Бережный (свежие аккаунты)",
    description: "Соответствует Дню 1 прогрева: 5 проверок, 15 сообщений в сутки",
    icon: Snail,
    values: {
      delay_min: 30,
      delay_max: 60,
  ...
  {
    id: "fast",
    label: "Прогретый (>30 дней)",
    description: "Только для аккаунтов с активной двусторонней перепиской",
    icon: Rabbit,
    values: {
      delay_min: 12,
      delay_max: 20,
      ...
      broadcast_delay_min: 12,
      broadcast_jitter_max: 8,
      daily_check_limit: 30,
      hourly_check_limit: 15,
